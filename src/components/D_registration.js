...
import "../App.css";
import  left_img from "./images/d_regis.jpeg"
    ...
    return (
        <div className="login">
            ...
            <form onSubmit={submit1}>
                <p>Donor Name <input className="name1" type="text" onChange={(e)=>setName(e.target.value)} /></p>
                <p>Gender <select className="select_gender" defaultValue="male" onChange={(e)=>setGender(e.target.value)}>
                  <option value="male">male</option>
                  <option value="female">female</option>      
                </select> </p>
                <p>Age <input onChange={(e)=>setAge(e.target.value)} className="age" type="number" /></p>
                ...
                <p>Email <input onChange={(e)=>setEmail(e.target.value)}className="name" type="email" /></p> 
                <p>Password <input onChange={(e)=>setPassword(e.target.value)}className="password" type="password" /></p>    
                <p>Adderess <input onChange={(e)=>setAdderess(e.target.value)}className="password" type="text" /></p>
